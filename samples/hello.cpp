...
int main(int, char**)
{
    ...
    float dpi_scaling = ddpi >= 120 ? 1.5f : 1.0f;
    ...
    SDL_Window* window = SDL_CreateWindow("Dear ImGui SDL2+OpenGL3 example", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, win_w, win_h, window_flags);
